// Test fixture: reference implementation of the AiDPix macro helpers (M4).
// These are the new-style ports of the legacy µ.$.* functions defined in
// µ.std.css. They are AiDPix-specific (not part of the public microCSS API)
// and live here only as the fixture for test/Macros.test.mjs and as the
// re-export target generated by the AiDPix migration acceptance test
// (tools/convert-mucss.mjs -> test:aidpix). They demonstrate the helper
// conventions of microCSS:
//
