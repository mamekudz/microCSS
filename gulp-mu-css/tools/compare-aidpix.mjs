// M5 acceptance test: builds the converted AiDPix skin with the new microCSS
// pipeline and compares the generated CSS structurally against the legacy
// compiled output (skins/std/std.css and friends).
//
...
//
// Usage: node tools/compare-aidpix.mjs [projectDir]
