...
>
> Siehe [`../README.md`](../README.md) für das Monorepo. Für neue Projekte die npm-Pakete
> verwenden; dieser Ordner dient als Archiv und Referenz der ursprünglichen Implementierung.
...
1. Repository inklusive Submodul klonen (`jsxlibs/` liegt unter diesem Ordner):
